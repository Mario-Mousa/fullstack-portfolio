...
export default function Admin() {
  ...
  if (location === "/admin/profile") content = <ProfileEditor />;
  if (location === "/admin/projects") content = <ProjectManager />;
  if (location === "/admin/certificates") content = <CertificateManager />;
  if (location === "/admin/messages") content = <Messages />;
