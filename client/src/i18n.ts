...
i18n.use(initReactI18next).init({
  resources: {
    en: { translation: {
      ...
      hero: { available: "Open to internship and junior opportunities", viewWork: "Explore selected work", contact: "Start a conversation", scroll: "Scroll to discover" },
      ...
      footer: { built: "Built as a database-driven portfolio.", dashboard: "Owner dashboard", rights: "All rights reserved." },
    ...
    ar: { translation: {
      ...
      hero: { available: "متاح لفرص التدريب والعمل كمطور مبتدئ", viewWork: "استكشف الأعمال المختارة", contact: "ابدأ محادثة", scroll: "اكتشف المزيد" },
      ...
      footer: { built: "بورتفوليو ديناميكي يعتمد على قاعدة بيانات.", dashboard: "لوحة المالك", rights: "جميع الحقوق محفوظة." },
